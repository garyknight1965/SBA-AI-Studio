...
class MulticamAudioSyncService:
    ...
    def _evaluate_pair(
        ...
        # Extract from the LATER of the two clips' start frames,
        # so both extractions start at genuinely overlapping
        # content rather than one clip's unrelated lead-in.
        ...
        # Sync succeeded: correct this clip's record_frame relative
        # to the reference clip's trusted position, using the
        # audio-derived offset rather than the raw timestamp delta.
